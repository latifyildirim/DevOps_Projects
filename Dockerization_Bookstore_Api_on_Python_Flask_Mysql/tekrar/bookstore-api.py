...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Latif_123'
...
# Write a function named `home` which returns 'Welcome to the Latif's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Latif's Bookstore API Service"
