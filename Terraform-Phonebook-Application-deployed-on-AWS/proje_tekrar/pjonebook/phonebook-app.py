...
db_endpoint = open("/home/ec2-user/pjonebook/dbserver.endpoint", 'r', encoding='UTF-8') 
...
app.config['MYSQL_DATABASE_HOST'] = db_endpoint.readline().strip() # ikinci bunu 'phonebook-app-db.c33ndfedld89.us-east-1.rds.amazonaws.com'  # ilk bunu komment yaptik db_endpoint.readline().strip()
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Latif.123'
app.config['MYSQL_DATABASE_DB'] = 'hemer'
...
# Write a function named `init_todo_db` create phonebook table within latif_phonebook db, if it doesn't exist
...
def init_phonebook_db():
    hemer_table = """
    CREATE TABLE IF NOT EXISTS hemer.phonebook( 
    ...
    """
    cursor.execute(hemer_table) # This is the connection to our database.
